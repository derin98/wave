...
module.exports = function (app) {
    ...
    app.get("/api/v1/permissionGroups/:id", [ authJwt.verifyToken, verifyBusinessUnitAfterAuth.verifyBusinessUnitId, verifyPermissionGroupReqBody.validatePermissionGroupId], permissionGroupController.getPermissionGroup);

    app.patch("/api/v1/permissionGroups/:id/enable", [ authJwt.verifyToken, verifyBusinessUnitAfterAuth.verifyBusinessUnitId, verifyPermissionGroupReqBody.validatePermissionGroupId], permissionGroupController.enablePermissionGroup);

    app.patch("/api/v1/permissionGroups/:id/disable", [ authJwt.verifyToken, verifyBusinessUnitAfterAuth.verifyBusinessUnitId, verifyPermissionGroupReqBody.validatePermissionGroupId], permissionGroupController.disablePermissionGroup);
    ...
    app.delete("/api/v1/permissionGroups/:id", [ authJwt.verifyToken, verifyBusinessUnitAfterAuth.verifyBusinessUnitId, verifyPermissionGroupReqBody.validatePermissionGroupId], permissionGroupController.deletePermissionGroup);
    ...
    app.put("/api/v1/permissionGroups/:id", [ authJwt.verifyToken, verifyBusinessUnitAfterAuth.verifyBusinessUnitId, verifyPermissionGroupReqBody.validateUpdatePermissionGroupRequestBody, verifyPermissionGroupReqBody.validatePermissionGroupId], permissionGroupController.updatePermissionGroup);
