...
module.exports = function (app) {
    ...
    app.get("/api/v1/businessUnits/:businessUnitId", [ authJwt.verifyToken, verifyBusinessUnitRequest.validateBusinessUnitId], businessUnitController.getBusinessUnit);

    app.patch("/api/v1/businessUnits/:businessUnitId/enable", [ authJwt.verifyToken, verifyBusinessUnitRequest.validateBusinessUnitId], businessUnitController.enableBusinessUnit);

    app.patch("/api/v1/businessUnits/:businessUnitId/disable", [authJwt.verifyToken, verifyBusinessUnitRequest.validateBusinessUnitId], businessUnitController.disableBusinessUnit);
    ...
    app.delete("/api/v1/businessUnits/:businessUnitId", [authJwt.verifyToken, verifyBusinessUnitRequest.validateBusinessUnitId], businessUnitController.deleteBusinessUnit);
    ...
    app.put("/api/v1/businessUnits/:businessUnitId", [ authJwt.verifyToken, verifyBusinessUnitRequest.validateUpdateBusinessUnitRequestBody, verifyBusinessUnitRequest.validateBusinessUnitId], businessUnitController.updateBusinessUnit);
