...
module.exports = function (app) {
    ...
    app.get("/api/v1/departments/:departmentId", [ authJwt.verifyToken, verifyBusinessUnitAfterAuth.verifyBusinessUnitId, verifyDepartmentReqBody.validateDepartmentId], departmentController.getDepartment);

    app.patch("/api/v1/departments/:departmentId/enable", [ authJwt.verifyToken, verifyBusinessUnitAfterAuth.verifyBusinessUnitId, verifyDepartmentReqBody.validateDepartmentId], departmentController.enableDepartment);

    app.patch("/api/v1/departments/:departmentId/disable", [ authJwt.verifyToken, verifyBusinessUnitAfterAuth.verifyBusinessUnitId, verifyDepartmentReqBody.validateDepartmentId], departmentController.disableDepartment);
    ...
    app.delete("/api/v1/departments/:departmentId", [ authJwt.verifyToken, verifyBusinessUnitAfterAuth.verifyBusinessUnitId, verifyDepartmentReqBody.validateDepartmentId], departmentController.deleteDepartment);
    ...
    app.put("/api/v1/departments/:departmentId", [ authJwt.verifyToken, verifyBusinessUnitAfterAuth.verifyBusinessUnitId, verifyDepartmentReqBody.validateUpdateDepartmentRequestBody, verifyDepartmentReqBody.validateDepartmentId], departmentController.updateDepartment);
