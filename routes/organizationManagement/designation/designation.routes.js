...
module.exports = function (app) {
    ...
    app.get("/api/v1/designations",  [ authJwt.verifyToken, verifyBusinessUnitAfterAuth.verifyBusinessUnit, verifyUserTypeReqBody.validateUserType ], designationController.getAllDesignations);
